...
import { BarChart3, Plus, Eye, Loader2 } from "lucide-react";
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-start justify-between gap-4">
        <div>
          <h1 className="text-3xl font-bold font-display">Análises de Mercado</h1>
          <p className="text-muted-foreground">
            Análises baseadas em comparáveis informados manualmente.
          </p>
        </div>
        ...
        <Card className="glass-card">
          <CardContent className="flex flex-col items-center justify-center py-16 text-center">
            ...
            <p className="text-sm text-muted-foreground mt-1">
              Cole os links dos imóveis comparáveis e gere uma análise.
            </p>
            <Button onClick={() => navigate("/market-studies/new")} className="mt-4 gap-2">
              <Plus className="h-4 w-4" /> Nova análise
            </Button>
          </CardContent>
        </Card>
                ...
                <CardContent className="p-6 flex items-center justify-between">
                  <div className="space-y-1">
                    <p className="font-semibold text-lg">
                      {study.title || "Análise sem título"}
                    </p>
